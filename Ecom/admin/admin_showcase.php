...
<div class="container min-w-[100vw] flex flex-row place-content-around">
...
<div class="flex justify-between items-start w-full">
    <div class="flex-col items-center">
      <div class="flex items-center mb-1">
          <h5 class="text-xl font-bold   text-gray-900 dark:text-white me-1">Website traffic</h5>
...
<div class="second-child overflow-y-hidden ">
</div>
