...
<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
    ...
    <tbody>
        ...
        while($row=mysqli_fetch_assoc($res_cart)){
                ...
                <td class='px-0 py-4'>
                <a href='view_category.php?id=$category_id' type='button' name='remove-btn' class='focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900'>Remove</button>
                </a>
            </td>
