...
<div class="container bg-[#111827] min-w-[100vw]">
...
<footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800 ">
  <div class="mx-auto max-w-screen-xl text-center">
      ...
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Akash</a>. All Rights Reserved.</span>
  </div>
</footer>
